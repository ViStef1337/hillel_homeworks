...
//
//     if (page > 1){//if page value is grater than 1 then add new li which is previous button
//         liTag += `<li class="btn prev" onclick="createPagination(totalPages,${page - 1})"><span><i class="fa-solid fa-chevron-left"></i>Prev</span></li>`
//     }
//
...
//
//     if (page < totalPages){ //if page value is less than totalPages value then add new li which is next button
//         liTag += `<li class="btn next" onclick="createPagination(totalPages,${page + 1})"><span>Next<i class="fa-solid fa-chevron-right"></i></span></li>`
//     }
//     ulTag.innerHTML = liTag
// }
// createPagination(totalPages,5) //calling function with passing values